using MyClinicHUB.Application.Common.Models;
using MyClinicHUB.Application.TodoItems.Commands.CreateTodoItem;
using MyClinicHUB.Application.TodoItems.Commands.DeleteTodoItem;
using MyClinicHUB.Application.TodoItems.Commands.UpdateTodoItem;
using MyClinicHUB.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MyClinicHUB.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace MyClinicHUB.Web.Endpoints;
